...
function HowItWorks() {
  const steps = [
    { icon: 'ph-copy',            n: 1, t: 'Copy the URL',     d: 'Open the post on X, YouTube, or Instagram, then copy the link from the address bar.' },
    { icon: 'ph-clipboard',       n: 2, t: 'Paste & queue',     d: 'Drop it in the field above. The control plane validates, signs, and dispatches to a worker.' },
    { icon: 'ph-download-simple', n: 3, t: 'Download from R2', d: 'The worker transcodes to the resolution you chose and uploads to R2. You get a direct link.' },
  ];
  return (
    <section className="section">
      <div className="section-head">
        ...
        <p className="section-lede">
          The same architecture that powers our SaaS — exposed cleanly so you can also run
          it yourself on a Mac mini.
        </p>
      </div>
      <div className="steps">
        {steps.map((s) => (
...
function FeatureGrid() {
  const features = [
    { i: 'ph-sparkle',       t: 'Original quality',   d: 'No re-encoding for supported sources. Up to 4K HDR where available — the same bytes that left the platform.', brand: true },
    { i: 'ph-lightning',     t: 'Edge dispatch',      d: 'Cloudflare Queues + Workers means jobs are dispatched in under 200ms, from any region.' },
    { i: 'ph-shield-check',  t: 'No watermarks',      d: 'Clean files. No overlays, no upsells embedded in your video.' },
    { i: 'ph-device-mobile', t: 'Works everywhere',   d: 'Browser, CLI, MCP, native extension — pick the surface that fits your workflow.' },
    { i: 'ph-user-minus',    t: 'No signup to try',   d: 'The free tier requires nothing more than your URL. Sign in only when you want history.' },
    { i: 'ph-lock',          t: 'Signed end-to-end',  d: 'HMAC between the control plane and every worker. Your jobs can\u2019t be intercepted or replayed.' },
  ];
  return (
  ...
  return (
    <section className="section" style={{ paddingTop: 0 }}>
      <div className="section-head">
        ...
        <p className="section-lede">
          MCP server, CLI, and llms.txt — the same surface every Claude / Cursor / Codex
          setup expects. No glue code, no swagger spelunking.
        </p>
      </div>
      <div className="agent">
        <div className="agent-card">
          <div className="row">
            ...
            <div style={{ flex: 1 }}>
              <h3>MCP server</h3>
              <p>One endpoint, one OAuth scope. Drop the URL into any MCP-aware client and your agent can submit and track download jobs.</p>
            </div>
          </div>
          <div className="code">
        ...
        <div className="agent-card">
          <div className="row">
            ...
            <div style={{ flex: 1 }}>
              <h3>CLI</h3>
              <p>One binary. Runs the same job format as the SaaS, against your own R2 bucket if you bring one.</p>
            </div>
          </div>
          <div className="code">
            <span className="com"># pull the latest binary</span><br/>
        ...
        <div className="agent-card">
          <div className="row">
            ...
            <div style={{ flex: 1 }}>
              <h3>llms.txt</h3>
              <p>Crawl-friendly description of every public endpoint, written by hand. No giant OpenAPI dump.</p>
            </div>
          </div>
        </div>
        <div className="agent-card">
  ...
  return (
    <section className="cta-wrap">
      <div className="cta">
        ...
        <p>Unlimited daily downloads, 10 GB file size, full 4K HDR, and access to every agent surface. $9/mo or two months free yearly.</p>
