  ...
  return (
    <>
      <section className="hero">
        ...
        <p className="lede">
          A control plane on Cloudflare Workers, a worker fleet on Mac mini and
          Docker, signed end-to-end. Paste a link — we handle the rest.
        </p>
        ...
        <div className="support-line">
          ...
          <span className="platform"><i className="ph ph-x-logo"></i> X / Twitter</span>
          <span>·</span>
          ...
          <span>·</span>
          <span className="platform"><i className="ph ph-tiktok-logo"></i> TikTok</span>
        </div>
      </section>
      ...
      <section className="trust">
        <div className="trust-inner">
          <div className="stat">
            <div className="num">12<span className="accent">M+</span></div>
