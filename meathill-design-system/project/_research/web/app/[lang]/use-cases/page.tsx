import { TrendUpIcon, ArchiveBoxIcon, ShareNetworkIcon, NewspaperIcon, RobotIcon } from '@phosphor-icons/react/ssr';
import { SUPPORTED_LANGS, isValidLang, getDictionary, DEFAULT_LANG, type Lang } from '@/lib/i18n';
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 pb-24 pt-16 sm:pt-24">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed">{t.subtitle}</p>
      </div>
