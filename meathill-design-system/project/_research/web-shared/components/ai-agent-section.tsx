import { PlugIcon, TerminalIcon, FileTextIcon, CodeIcon } from '@phosphor-icons/react/ssr';
...
export function AiAgentSection({ dict }: Props) {
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 pb-14">
      ...
      <p className="mx-auto mb-10 max-w-2xl text-center text-muted-foreground leading-relaxed">{dict.subtitle}</p>
