  ...
  return (
    <>
      <section className="hero">
        ...
        <p className="lede">
          控制面跑在 Cloudflare Workers，执行面跑在 Mac mini 和 Docker 上，端到端 HMAC
          签名。粘贴链接，剩下的交给我们。
        </p>
        ...
        <div className="support-line">
          ...
          <span className="platform">
            <i className="ph ph-x-logo"></i> X / 推特
          </span>
          <span>·</span>
          <span className="platform">
          ...
          <span>·</span>
          <span className="platform">
            <i className="ph ph-tiktok-logo"></i> 抖音
          </span>
        </div>
      </section>
      ...
      <section className="trust">
        <div className="trust-inner">
          <div className="stat">
            <div className="num">
              1200<span className="accent">万+</span>
            </div>
      ...
      <div className="nav-inner">
        ...
        <div className="nav-right">
          <button className="lang-pill">
            <i className="ph ph-globe"></i> 中文
          </button>
          <ThemeToggle />
          <a href="#" className="btn btn-md btn-ghost">
            登录
          </a>
          <a href="../app-dashboard/index.html" className="btn btn-md btn-primary">
            立即开始 →
          </a>
        </div>
      </div>
  ...
  return (
    <section className="section" style={{ paddingTop: 0 }}>
      <div className="section-head">
        ...
        <p className="section-lede">
          MCP server、CLI、llms.txt — 任何 Claude / Cursor / Codex
          接得上的标准接口。无需胶水代码，无需翻 Swagger 文档。
        </p>
      </div>
      <div className="agent">
        <div className="agent-card">
          <div className="row">
            ...
            <div style={{ flex: 1 }}>
              <h3>MCP server</h3>
              <p>
                一个 endpoint，一个 OAuth scope。把 URL 填进任何支持 MCP 的客户端，你的 agent
                就能提交和跟踪下载任务。
              </p>
            </div>
          </div>
        ...
        <div className="agent-card">
          <div className="row">
            ...
            <div style={{ flex: 1 }}>
              <h3>命令行</h3>
              <p>
                一个二进制文件。与 SaaS 跑的是同一套任务格式，可以让任务结果直接落到你自己的 R2
                bucket。
              </p>
            </div>
          </div>
          <div className="code">
            <span className="com"># 安装最新版</span>
            <br />
  ...
  return (
    <section className="cta-wrap">
      <div className="cta">
        ...
        <p>
          每日无限下载，10 GB 单文件上限，完整 4K HDR，全部 agent 接口可用。月付 ¥69
          或年付直接省两个月。
        </p>
        ...
        <div className="footer-cross">
          ...
          <div className="cross-links">
            <a className="cross-link" href="#">
              <i className="ph ph-x-logo" style={{ color: '#14171A' }}></i>X / 推特视频下载
            </a>
            <a className="cross-link" href="#">
