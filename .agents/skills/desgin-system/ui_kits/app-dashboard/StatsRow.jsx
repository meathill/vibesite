  ...
  return (
    <div className="stats-row">
      <div className="stat-tile brand">
        ...
        <div className="val">
          {isPro ? 'Pro' : 'Free'}{' '}
          <span className="accent">{isPro ? '· unlimited' : '· 7 left'}</span>
        </div>
        <div className="trend">
          <i className="ph ph-crown"></i> {isPro ? 'renews Dec 12' : 'upgrade for 4K HDR'}
        </div>
      </div>
      <div className="stat-tile">
        ...
        <div className="trend">
          <i className="ph ph-arrow-up"></i> 3 this hour
        </div>
      </div>
      <div className="stat-tile">
        ...
        <div className="trend">
          <i className="ph ph-lightning"></i> avg 18s/job
        </div>
      </div>
      <div className="stat-tile">
...
function UpgradeBanner({ visible, onDismiss }) {
  ...
  return (
    <div className="upgrade-banner">
      ...
      <button className="btn btn-md btn-outline" onClick={onDismiss}>
        Maybe later
      </button>
