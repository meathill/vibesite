import { DEFAULT_LANG, type Lang, getDictionary, isValidLang, langPrefix } from '@/lib/i18n';
...
export default async function PricingPage({ params, searchParams }: Props) {
  ...
  const features = [
    ...
    {
      name: f.fileSize,
      free: formatBytes(free.maxFileSizeBytes),
      pro: formatBytes(pro.maxFileSizeBytes),
    },
